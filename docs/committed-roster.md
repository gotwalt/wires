...
The second concrete step toward the [fabric vision](./fabric-vision.md): a
...
[membership credential](./provable-fabric-inclusion.md)) but "is this node a
...
[slice-1 rule](./provable-fabric-inclusion.md) applies verbatim: **optional-but-signed
